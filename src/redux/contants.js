...
export const CITY_GET_LIST_WITH_FILTER = 'CITY_GET_LIST_WITH_FILTER';
export const CITY_GET_LIST_WITH_ORDER = 'CITY_GET_LIST_WITH_ORDER';
export const CITY_GET_LIST_SEARCH = 'CITY_GET_LIST_SEARCH';
...
export const ZIP_ADD_ITEM = 'ZIP_ADD_ITEM';
export const ZIP_ADD_ITEM_SUCCESS = 'ZIP_ADD_ITEM_SUCCESS';
export const ZIP_ADD_ITEM_ERROR = 'ZIP_ADD_ITEM_ERROR';
export const ZIP_REMOVE_ITEM = 'ZIP_REMOVE_ITEM';
export const CITY_SELECTED_ITEMS_CHANGE = 'CITY_SELECTED_ITEMS_CHANGE';
